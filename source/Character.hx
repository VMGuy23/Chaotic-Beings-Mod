	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24, true, true);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24, true, true);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24, true, true);
				animation.addByPrefix('singDOWN', 'Dad Sing Note DOWN', 24, true, true);
				animation.addByPrefix('singLEFT', 'Dad Sing Note LEFT', 24, true, true);
